...
<div align="left">
   <img src="https://skillicons.dev/icons?i=arch,linux,bash,git,github,vscodium,obsidian,clion,rider,pycharm,unity,dotnet,c,cpp,cs,py,raspberrypi,arduino,docker,html,css" />
   <!-- cmake,discord,githubactions,gitlab,latex,md,mastodon,idea,java,lua,powershell,rust,vscode,visualstudio,windows, -->
</div>
...
[![trophy](https://trophygithubreadmelang.cybee.dpdns.org/?username=astra1dev&theme=dracula&margin-w=4&margin-h=4)](https://github.com/ryo-ma/github-profile-trophy)
